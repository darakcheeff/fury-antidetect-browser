...
| Подпись и нотаризация | инструменты написаны ([sign-core.sh](tools/release/sign-core.sh), [sign-shell.sh](tools/release/sign-shell.sh)); сертификат Apple Developer оплачен 15.08.2026 и ждёт активации. До него macOS показывает «неизвестный разработчик» (правый клик → Открыть), Windows — SmartScreen |
