...
>
> Пока этого нет, скачанные сборки всё равно запускаются — нужен один лишний
> шаг. Сборка для macOS подписана ad-hoc, поэтому Gatekeeper отказывается её
...
> из исходников обходит и то, и другое. В любом случае до сертификата любой
> релиз — предварительный; по шагам — в [docs/15](docs/15-install.ru.md).
>
...
| Подпись и нотаризация | инструменты написаны ([sign-core.sh](tools/release/sign-core.sh), [sign-shell.sh](tools/release/sign-shell.sh)); сертификат Apple Developer оплачен 15.08.2026 и ждёт активации. До него macOS говорит «повреждён» (снять карантинный флаг или «Конфиденциальность и безопасность → Всё равно открыть» — [docs/15](docs/15-install.ru.md)), Windows — SmartScreen |
