...
const en = {
  ...
  "cap.next": "To contribute it, open a pull request adding the file under shared/personas/contributed/ — the template asks three questions.",
  "pd.seed": "Fingerprint",
...
const ru: Record<Key, string> = {
  ...
  "cap.next": "Чтобы добавить в каталог, откройте pull request с файлом в shared/personas/contributed/ — шаблон задаст три вопроса.",
